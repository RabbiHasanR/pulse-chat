...
from .views import SendMessageView, SignBatchView, CompleteUpload, ChatListView, ChatMessageListView, ForwardMessageView, MessageOffsetListView
...
urlpatterns = [
    ...
    path('messages/offset/', MessageOffsetListView.as_view(), name='messages-offset'),
]